...
<ParamField path="parameter_space" type="opik_optimizer.algorithms.parameter_optimizer.parameter_search_space.ParameterSearchSpace | collections.abc.Mapping[str, typing.Any]">Definition of the search space for tunable parameters. For multi-prompt, params without a prefix are expanded per prompt. Params already prefixed (e.g., 'analyze.temperature') are kept as-is.</ParamField>
...
<ParamField path="prompt" type="opik_optimizer.api_objects.chat_prompt.ChatPrompt | dict[str, opik_optimizer.api_objects.chat_prompt.ChatPrompt]">The prompt to optimize</ParamField>
<ParamField path="dataset" type="Dataset">Opik Dataset to optimize on</ParamField>
<ParamField path="metric" type="MetricFunction">Metric function to evaluate on</ParamField>
<ParamField path="agent" type="opik_optimizer.agents.optimizable_agent.OptimizableAgent | None" optional={true} />
...
<ParamField path="prompt" type="opik_optimizer.api_objects.chat_prompt.ChatPrompt | dict[str, opik_optimizer.api_objects.chat_prompt.ChatPrompt]">The ChatPrompt to optimize. Can include system/user/assistant messages, tools, and model configuration.</ParamField>
...
<ParamField path="metric" type="MetricFunction">Evaluation function that takes (dataset_item, llm_output) and returns a score (float). Higher scores indicate better performance.</ParamField>
<ParamField path="agent" type="opik_optimizer.agents.optimizable_agent.OptimizableAgent | None" optional={true} />
...
<ParamField path="prompt" type="opik_optimizer.api_objects.chat_prompt.ChatPrompt | dict[str, opik_optimizer.api_objects.chat_prompt.ChatPrompt]">The prompt to optimize (single ChatPrompt or dict of ChatPrompts).</ParamField>
<ParamField path="dataset" type="Dataset">Dataset used to evaluate each candidate prompt.</ParamField>
<ParamField path="metric" type="MetricFunction">Objective function receiving `(dataset_item, llm_output)`.</ParamField>
<ParamField path="agent" type="opik_optimizer.agents.optimizable_agent.OptimizableAgent | None" optional={true}>Optional agent instance for executing prompts. If None, uses LiteLLMAgent.</ParamField>
...
<ParamField path="prompt" type="opik_optimizer.api_objects.chat_prompt.ChatPrompt | dict[str, opik_optimizer.api_objects.chat_prompt.ChatPrompt]">The prompt(s) to optimize. Can be a single ChatPrompt or a dict of ChatPrompts. All message types (system, user, assistant) will be optimized.</ParamField>
<ParamField path="dataset" type="Dataset">Opik Dataset to optimize on</ParamField>
<ParamField path="metric" type="MetricFunction">Metric function to evaluate on</ParamField>
<ParamField path="agent" type="opik_optimizer.agents.optimizable_agent.OptimizableAgent | None" optional={true}>Optional agent instance to use for evaluation. If None, uses LiteLLMAgent.</ParamField>
...
<ParamField path="perfect_score" type="float" optional={true} default="0.95">Score considered perfect (default: 1.0)</ParamField>
...
<ParamField path="prompt" type="opik_optimizer.api_objects.chat_prompt.ChatPrompt | dict[str, opik_optimizer.api_objects.chat_prompt.ChatPrompt]">The chat prompt(s) to optimize. Can be a single ChatPrompt or a dict of ChatPrompts.</ParamField>
<ParamField path="dataset" type="Dataset">Dataset containing evaluation examples.</ParamField>
<ParamField path="metric" type="MetricFunction">Callable that scores `(dataset_item, llm_output)`. Optional Arguments:</ParamField>
<ParamField path="agent" type="opik_optimizer.agents.optimizable_agent.OptimizableAgent | None" optional={true} />
